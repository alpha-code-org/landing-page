...
As you can see, there is a nice mix on functional code as well with <Highlight>reduce HOF</Highlight>.
...
for other developers and chaining methods is much more in tune with how humans think. Just try to think in recurssion?! 🤯
